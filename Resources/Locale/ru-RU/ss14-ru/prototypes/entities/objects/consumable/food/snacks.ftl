...
ent-FoodSnackChocolateBar = плитка шоколада
    .desc = На вкус как картон.
ent-FoodSnackCotton = Шёлковый батончик
    .desc = Это шёлковый батончик, сделанный из дешёвых ингридиентов.
ent-FoodSnackCottonBar = Шёлковый батончик
    .desc = Это шёлковый батончик, сделанный из дешёвых ингридиентов.
...
ent-FoodPacketChocolateTrash = обёртка от шоколада
    .desc = { ent-FoodPacketTrash.desc }
ent-FoodPacketCottonTrash = обёртка от шёлкового батончика
    .desc = { ent-FoodPacketTrash.desc }
