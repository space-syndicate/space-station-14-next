...
ghost-bar-rules = Находясь в этой роли придерживайтесь правил обычного призрака. Вы можете обсуждать любые текущие события раунда в открытом чате (без использования LOOC) и сохраняете воспоминания о своей прошлой жизни. ЗАПРЕЩЕНО нападать на других игроков, провоцировать конфликты и повреждать имущество бара. Если вы заметите нарушителей, сообщите администрации через Ahelp, и они будут немедленно отправлены в открытый космос. Покинув Призрачный Бар, вы полностью забудете все, что происходило здесь, а также события вашей прошлой жизни.
