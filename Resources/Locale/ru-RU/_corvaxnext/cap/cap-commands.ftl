...
cmd-setvotescount-help = Использование: setvotescount <vote_id> <option> <count>. Здесь vote_id - id голосования (из listvotes), option - номер варианта (с нуля), count - количество голосов

cmd-capshared-success-msg = Поздравляю, вы уничтожили демократию ;)
cmd-capshared-arg-vote-id = <vote_id>
cmd-capshared-arg-option = <option>
cmd-capshared-arg-count = <count>
