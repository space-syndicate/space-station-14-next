heretic-ascension-ash =
    ...
    ибо Ночной Дозор принес обряд человечеству! Его взгляд продолжается, и теперь я един с пламенем,
    СВИДЕТЕЛЬ МОЕГО ВОЗНЕССЕНИЯ, ПЕПЕЛЬНЫЙ ФОНАРЬ ПЫЛАЕТ ВНОВЬ!
    heretic-ascension-blade =
    Разорванный чемпион освобожден! Я стану воссоединенным, и с моими большими амбициями,
    МНЕ НЕТ РАВНЫХ! БУРЯ СТАЛИ И СЕРЕБРА НАДВИГАЕТСЯ НА НАС! СТАНЬТЕ СВИДЕТЕЛЕМ МОЕГО ВОЗНЕССЕНИЯ!
    ...
    Реальность покорится Владыке Ночи или будет разгадана! СТАНЬТЕ СВИДЕТЕЛЯМИ МОЕГО ВОЗНЕССЕНИЯ!
    ...
    Чемпион ржавчины. Коррупционер стали. Бойтесь темноты, потому что пришел РОСТБРИНГЕР!
    Кузнец идет вперед! Ржавые холмы, зовите меня по имени! СТАНЬТЕ СВИДЕТЕЛЯМИ МОЕГО ВОЗНЕССЕНИЯ!
