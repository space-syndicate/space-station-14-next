...
roundend-prepend-heretic-knowledge-named = [color=white]{ $name }[/color] всего исследовали [color=purple]{ $number }[/color] знаний.
heretic-gamemode-title = Еретики
heretic-gamemode-description = В пределах станции обнаружена пространственная аномалия. Дополнительные данные отсутствуют.
