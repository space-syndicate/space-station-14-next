...
heretic-blade-examine = [color=yellow]Если использовать его, пока он в вашей руке, вы сломаете лезвие и телепортируетесь подальше от опасности.[/color]
heretic-blade-use = Лезвие разбивается вдребезги, и вы чувствуете, как голоса уводят вас прочь.

## paths exclusive

heretic-rust-mark-itembreak = { $name } обращается в пыль!
heretic-blade-void-examine = [color=cyan]Если в непосредственной близости находится хотя бы один отмеченный верующий, телепортируйтесь ему за спину, не сломав клинок.[/color]
