...
knowledge-path-void-s1-desc =
    Я чувствую сияние в воздухе, воздух вокруг меня становится все холоднее.
...
knowledge-path-void-s2-desc =
    Я увидел хладного наблюдателя, что следит за мной. Во мне бушует буран.
    Они молчат. Это еще не конец загадки.
...
knowledge-path-void-s3-desc =
    Я увидел нить прохладного дыхания. Она привела меня в странное святилище, сплошь состоящее из кристаллов.
...
knowledge-path-void-s4-desc =
    Порыв ветра? Сияние в воздухе? Происходящее ошеломляет, мои чувства начинают предавать меня. Мой разум — мой собственный враг.
...
knowledge-path-void-s5-desc =
    Каждая дверь, которую я открываю, сковывает мое тело. Я боюсь того, что находится за ними. Кто-то ждет меня,
...
knowledge-path-void-s6-desc =
    Существо называет себя Аристократом. Они легко проходят сквозь воздух, как сквозь пустоту, оставляя после себя суровый морозный ветер.
...
knowledge-path-void-s7-desc =
    Мимолетные воспоминания, мимолетные шаги. Я помечаю свой путь застывшей кровью на снегу. Я укрыт снегом и забыт.
...
knowledge-path-void-s8-desc =
    Все мимолетно, но что остается дольше? Я близок к тому, чтобы закончить начатое.
    Аристократ снова предстает предо мной. Они говорят мне, что я опоздал. Их притяжение огромно, я не могу повернуть назад.
