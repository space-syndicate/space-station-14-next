...
alert-level-blue-announcement = На станции присутствует или может присутствовать малая угроза станции. Экипаж обязан информировать службу безопасности о любой подозрительной активности. Члены экипажа обязаны прекратить движение при получении звукового сигнала свистка. Ношение ID-карт на поясе является обязательным.
