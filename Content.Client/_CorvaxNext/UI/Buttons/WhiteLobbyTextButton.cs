...
namespace Content.Client._CorvaxNext.UI.Buttons;
...
public class WhiteLobbyTextButton : TextureButton
{
    ...
    public WhiteLobbyTextButton()
    {
        ...
        _font = new VectorFont(_resourceCache.GetResource<FontResource>("/Fonts/_CorvaxNext/Bedstead/Bedstead.otf"), 15);
    }
