...
namespace Content.Client.Stylesheets
{
    ...
    public sealed class StyleNano : StyleBase
    {
        ...
        public const string StyleClassLobbyBackground = "LobbyBackground"; // Corvax-Next-Lobby
        public const string StyleClassPanelBackground = "PanelBackground"; // Corvax-Next-Lobby
        ...
        public StyleNano(IResourceCache resCache) : base(resCache)
        {
            ...
            var tabContainerPanelTex = resCache.GetTexture("/Textures/_CorvaxNext/Interface/Nano/lobby.png"); // Corvax-Next-Lobby
            ...
            var lobbyBackgroundTex = resCache.GetTexture("/Textures/_CorvaxNext/Interface/Nano/lobby.png");
            ...
            var panelBackgroundTex = resCache.GetTexture("/Textures/_CorvaxNext/Interface/Nano/panel.png");
...
// ListContainer
                ...
                Element<PanelContainer>().Class(ClassAngleRect)
                    ...
                    .Prop(Control.StylePropertyModulateSelf, Color.FromHex("#0f0f0f")), // Corvax-Next-Lobby
