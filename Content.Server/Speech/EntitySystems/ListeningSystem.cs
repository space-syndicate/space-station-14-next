...
{
    [Dependency] private readonly ChatSystem _chat = default!; // Corvax-Languages
    ...
    {
        PingListeners(ev.Source, ev.Message, ev.IsWhisper); // Corvax-Languages

    }

    public void PingListeners(EntityUid source, string message, bool isWhisper) // Corvax-Languages
    {
        ...
        var obfuscatedEv = !isWhisper ? null : new ListenEvent(_chat.ObfuscateMessageReadability(message), source); // Corvax-Languages
