...
public sealed class SurveillanceCameraSpeakerSystem : EntitySystem
{
        ...
        SurveillanceCameraSpeechSendEvent args)
    {
        ...
        _chatSystem.TrySendInGameICMessage(uid, args.Message, SharedChatSystem.InGameICChatType.Speak, SharedChatSystem.ChatTransmitRange.GhostRangeLimit, nameOverride: name); // Corvax-Languages
    }
}
