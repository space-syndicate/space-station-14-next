...
public sealed partial class MedibotInjectOperator : HTNOperator
{
    ...
    public override HTNOperatorStatus Update(NPCBlackboard blackboard, float frameTime)
    {
        ...
        _chat.TrySendInGameICMessage(owner, Loc.GetString("medibot-finish-inject"), SharedChatSystem.InGameICChatType.Speak, hideChat: true, hideLog: true); // Corvax-Languages
