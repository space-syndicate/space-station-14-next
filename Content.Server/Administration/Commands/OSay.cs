...
public sealed class OSay : LocalizedCommands
{
    ...
    public override CompletionResult GetCompletion(IConsoleShell shell, string[] args)
    {
        ...
        if (args.Length == 2)
        {
            return CompletionResult.FromHintOptions( Enum.GetNames(typeof(SharedChatSystem.InGameICChatType)), // Corvax-Languages
    ...
    public override void Execute(IConsoleShell shell, string argStr, string[] args)
    {
        ...
        var chatType =
            (SharedChatSystem.InGameICChatType)Enum.Parse(typeof(SharedChatSystem.InGameICChatType), args[1]); // Corvax-Languages
