    ...
    internal sealed class WhisperCommand : IConsoleCommand
    {
        ...
        public void Execute(IConsoleShell shell, string argStr, string[] args)
        {
            ...
            IoCManager.Resolve<IEntitySystemManager>().GetEntitySystem<ChatSystem>()
                .TrySendInGameICMessage(playerEntity, message, SharedChatSystem.InGameICChatType.Whisper, SharedChatSystem.ChatTransmitRange.Normal, false, shell, player); // Corvax-Languages
        }
    }
}
