    ...
    internal sealed class SayCommand : IConsoleCommand
    {
        ...
        public void Execute(IConsoleShell shell, string argStr, string[] args)
        {
            ...
            IoCManager.Resolve<IEntitySystemManager>().GetEntitySystem<ChatSystem>()
                .TrySendInGameICMessage(playerEntity, message, SharedChatSystem.InGameICChatType.Speak, SharedChatSystem.ChatTransmitRange.Normal, false, shell, player); // Corvax-Languages
        }
    }
}
