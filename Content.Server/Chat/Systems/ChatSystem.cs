...
using Content.Server.Speech; // Corvax-Languages
...
public sealed partial class ChatSystem : SharedChatSystem
{
    ...
    public void TrySendInGameICMessage(
        ...
        LanguagePrototype? languageOverride = null // Corvax-Languages
        )
    {
        ...
        )
    {
        ...
        var language = languageOverride ?? _language.GetLanguage(source); // Corvax-Languages
        ...
        {
            SendEntityEmote(source, emoteStr, range, nameOverride, language, ignoreActionBlocker); // Corvax-Languages
        }
...
// Corvax-Languages-End
        ...
        if (checkRadioPrefix)
        {
            ...
            {
                SendEntityWhisper(source, modMessage, range, channel, nameOverride, language, hideLog, ignoreActionBlocker);  // Corvax Languages
                return;
            }
        }
        ...
        switch (desiredType)
        {
            case InGameICChatType.Speak:
                SendEntitySpeak(source, message, range, nameOverride, language, hideLog, ignoreActionBlocker); // Corvax-Languages
                break;
            case InGameICChatType.Whisper:
                SendEntityWhisper(source, message, range, null, nameOverride, language, hideLog, ignoreActionBlocker); // Corvax-Languages
                break;
            case InGameICChatType.Emote:
                SendEntityEmote(source, message, range, nameOverride, language, hideLog: hideLog, ignoreActionBlocker: ignoreActionBlocker); // Corvax-Languages
                break;
        }
    }
    ...
    private void SendEntitySpeak(
        ...
        ChatTransmitRange range,
        string? nameOverride,
        LanguagePrototype language, // Corvax-Languages
        bool hideLog = false,
        bool ignoreActionBlocker = false
        )
    {
        ...
        var message = TransformSpeech(source, FormattedMessage.RemoveMarkup(originalMessage), language); // Corvax-Languages
...
// Corvax-Languages-End
        ...
        {
            if (session.AttachedEntity is not { Valid: true } listener) // Corvax-Languages
                continue;
...
// Corvax-Languages-End
        ...
        )
    {
        ...
        var wrappedMessage = Loc.GetString("chat-manager-entity-me-wrap-message",
            ("entityName", name),
            ("entity", ent),
            ("message", FormattedMessage.RemoveMarkup(action))); // Corvax-Languages

        if (checkEmote)
            TryEmoteChatInput(source, action);
        SendInVoiceRange(ChatChannel.Emotes, name, action, wrappedMessage, obfuscated: "", obfuscatedWrappedMessage: "", source, range, author); // Corvax-Languages
        if (!hideLog)
            if (name != Name(source))
...
// Corvax-Languages-End
    ...
    /// </summary>
    private void SendInVoiceRange(ChatChannel channel, string name, string message, string wrappedMessage, string obfuscated, string obfuscatedWrappedMessage, EntityUid source, ChatTransmitRange range, NetUserId? author = null, LanguagePrototype? languageOverride = null) // Corvax-Languages
    {
        var language = languageOverride ?? _language.GetLanguage(source); // Corvax-Languages
...
// Corvax-Languages-End
    ...
    public string ObfuscateMessageReadability(string message, float chance = DefaultObfuscationFactor) // Corvax-Languages
    {
...
public sealed class EntitySpokeEvent : EntityEventArgs
{
    ...
    public EntitySpokeEvent(EntityUid source, string message, string originalMessage, RadioChannelPrototype? channel, string? obfuscatedMessage)
    {
        ...
        Channel = channel;
        IsWhisper = isWhisper; // Corvax-Languages
        Language = language; // Corvax-Languages
    }
}
