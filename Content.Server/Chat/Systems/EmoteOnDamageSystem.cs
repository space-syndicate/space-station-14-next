...
public sealed class EmoteOnDamageSystem : EntitySystem
{
    ...
    private void OnDamage(EntityUid uid, EmoteOnDamageComponent emoteOnDamage, DamageChangedEvent args)
    {
        ...
        {
            _chatSystem.TryEmoteWithChat(uid, emote, emoteOnDamage.HiddenFromChatWindow ? SharedChatSystem.ChatTransmitRange.HideChat : SharedChatSystem.ChatTransmitRange.Normal); // Corvax-Languages
        }
        else
        {
