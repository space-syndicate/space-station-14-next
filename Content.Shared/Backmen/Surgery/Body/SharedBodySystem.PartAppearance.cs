...
public partial class SharedBodySystem
{
    ...
    private void OnPartAttachedToBody(EntityUid uid, BodyComponent component, ref BodyPartAttachedEvent args)
    {
        ...
        // _humanoid.SetBaseLayerId(uid, partAppearance.Type, partAppearance.ID, sync: true, bodyAppearance); // Corvax-next changes : for some reason this thing breaks everything because of "removed + Name of the part" (for ex. removedRightHand, removedLeftLeg etc), it would be fixed in future
